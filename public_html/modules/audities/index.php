...
if(getAuditiepakketStatus())
{
    ...
    if((!isset($_POST['send'])) || (is_array($result)))
    {
        	...
        	if(count($result)>0)
                ...
                $html->addCustomMeta('og:description',"Kan je goed zingen en heb je zin in een uitdaging? Je hebt er altijd al van gedroomd om in groep 4 tot 8-stemmig te zingen ? Ben je ouder dan 18 jaar? Dan zit je goed want CHANTage zoekt nieuwe zangers/zangeressen voor haar volgende project.");
